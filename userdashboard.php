            ...
            <h2 >User Profile Card</h2>
             <div class="card">
              ...
              <p class="title"><label>Email:</label><?= $resultCard[0]['email']; ?></p>
                <div class="cardicons">
                  <a href="https://github.com/login" target="_blank"><i class="fa fa-github"></i></a> 
                  <a href="https://twitter.com/login?lang=en" target="_blank"><i class="fa fa-twitter"></i></a>  
                  <a href="https://www.linkedin.com/start/join?_l=en" target="_blank"><i class="fa fa-linkedin"></i></a>  
